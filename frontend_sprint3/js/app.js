...
app.component("consultarequipo-visitante",{
    ...
    <img src="img/diagram-3-fill.svg" height="150">
        ...
        <br />
        <button class="btn btn-info" v-on:click="consultarequipoVisitante">
        Buscar
        </button>
...
app.component("consultarequipo-local",{
    ...
    <section id="tablaporlocal">
        ...
        <br />
        <button class="btn btn-warning" v-on:click="consultarequipoLocal">
        Buscar
        </button>
...
app.component("consultar-deporte",{
    ...
    <section id="tablapordeporte">
        ...
        <br />
        <button class="btn btn-success" v-on:click="consultarDeporte">
        Buscar
        </button>
...
app.component("consultar-pais",{
    ...
    <section id="tablaporpais">
        ...
        <br />
        <button class="btn btn-danger" v-on:click="consultarPais">
        Buscar
        </button>
...
app.component("consultar-fecha",{
    ...
    <div align="center">
        ...
        <br />
        <button class="btn btn-primary" v-on:click="consultarFecha">
        Buscar
        </button>
